...
public class _5OwnerMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(_5OwnerMenu.this))
            buildDialog(_5OwnerMenu.this).show();




        //......................................getting the id of the contents of layout 11
        main_menu_layout = findViewById(R.id.main_menu_layout_5);
        main_menu_layout_right = findViewById(R.id.main_menu_layout_5right);
        home_layout = findViewById(R.id.home_layout_5);
        menu_btn = findViewById(R.id.menu_btn_5);
        see_more_btn= findViewById(R.id.see_more_btn_5);
        name_title= findViewById(R.id.nameTitle_5);
        address_title= findViewById(R.id.addressTitle_5);

        //..............................getting id of menu items
        add_tenant_btn = findViewById(R.id.add_tenant_btn_5);
        notices_btn = findViewById(R.id.notices_btn_5);
        manage_tenant_btn = findViewById(R.id.manage_tenant_btn_5);
        ///////////////////////////////////////////////////////////////////////////////////////////send_bills_btn = findViewById(R.id.send_bills_btn_11);
        ///////////////////////////////////////////////////////////////////////////////////////////////settings_btn = findViewById(R.id.settings_btn_11);
        signout_btn = findViewById(R.id.signout_5);
        ...
        add_tenant_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent11 = new Intent(_5OwnerMenu.this, _7_Register_Tenants.class);
        ...
        notices_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent11 = new Intent(_5OwnerMenu.this, _8_Notices.class);
                startActivity(intent11);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        manage_tenant_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent11 = new Intent(_5OwnerMenu.this, _9_Manage_Tenants.class);
                startActivity(intent11);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        see_more_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent11 = new Intent(_5OwnerMenu.this, _10_More_Requests.class);
                startActivity(intent11);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        ...
        signout_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent11 = new Intent(_5OwnerMenu.this, _3Login.class);
                startActivity(intent11);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
        //........................................Refreshing method............................................//
        final SwipeRefreshLayout swipeRefreshLayout = findViewById(R.id.page_layout_5);
